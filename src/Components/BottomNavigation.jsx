  ...
  return (
    ...
    >
      <path
        ...
        fill={selected ? "#FFC42C" : "#0E816C"}
      />
    </svg>
  );
}

function moodNightMode(selected) {
  return (
    <svg
      width="25"
      height="24"
...
function journalNightmode(selected) {
  return (
    <svg
      width="25"
      height="24"
...
function exploreNightSVG(selected) {
  return (
    <svg
      width="21"
      height="20"
...
function SleepNightSVG(selected) {
  return (
    <svg
      width="24"
      height="24"
